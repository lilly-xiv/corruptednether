...
import static lordruby.corruptednether.init.EntityInit.CORRUPTED_SKELETON;
...
public class CorruptedNether implements ModInitializer {
	...
	public void onInitialize() {
		...
		SpawnRestriction.register(CORRUPTED_SKELETON, SpawnLocationTypes.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HostileEntity::canSpawnInDark);
